...
internal class ReportAdapter(inflater: LayoutInflater) : StatefulRecyclerAdapter(inflater, 2) {
  private val screenIds = listOf(
    R.string.squash_it_issue_tab_title to R.layout.squash_it_issue_page,
    R.string.squash_it_add_ons_tab_title to R.layout.squash_it_add_ons_page
  )
